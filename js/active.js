...
// функция смены слайдов выполняется каждые 5 секунд
setInterval(function() {
    // находим все слайды
    var slides = document.querySelectorAll('.hero-slide');
    // находим активный слайд
    var activeSlide = document.querySelector('.hero-slide.active');
    // определяем следующий слайд (или возвращаемся к первому)
...
function startCountdown() {
    // устанавливаем дату окончания акции (через 24 часа)
